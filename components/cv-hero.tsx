  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex items-center justify-center bg-black">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full bg-gradient-to-br from-cyan-500/10 to-transparent blur-3xl opacity-40 animate-blob animation-delay-2000" />
      </div>
          ...
          <div className="space-y-6 animate-fade-in">
            <div>
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-black mb-2 text-balance tracking-tighter">
                ...
                <span className="block mt-2 bg-gradient-to-r from-blue-400 via-cyan-500 to-indigo-500 bg-clip-text text-transparent animate-gradient">Imtiaz</span>
              </h1>
              <div className="h-1.5 w-32 bg-gradient-to-r from-blue-400 via-cyan-500 to-indigo-500 rounded-full mt-4 animate-pulse-glow" />
            </div>
